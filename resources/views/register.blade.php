<x-base-html>
    <div class="h-screen m-0 bg-aliceBlue row font-inter">
        <div class="relative hidden lg:block col-6">
            <img src="{{ asset('assets/icons/t_quarter_pill_2.png') }}" alt="icon"
                class="absolute top-0 -translate-x-1/2 start-1/2" width="300">
            <img src="{{ asset('assets/images/logo_full.png') }}" alt="image"
                class="absolute -translate-x-1/2 top-28 start-1/2">
            <img src="{{ asset('assets/icons/computer.png') }}" alt="icon" class="absolute bottom-0 end-12"
                width="350">
        </div>
